...
from uusio.pro_connectors.base import (
    BasePROConnector,
    ReportFile,
    SubmissionResult,
    SubmissionStatus,
...
class NordicPROConnector(BasePROConnector):
    ...
    Args:
        output_dir: Directory for generated report files. Defaults to /tmp/uusio_reports.
    """
    ...
    def __init__(self, output_dir: str = "/tmp/uusio_reports") -> None:
