...
from uusio.core.security import decrypt_config, encrypt_config
from uusio.ingestion.csv_ingestor import CSVIngestor
from uusio.ingestion.base import DataSourceConfig
from uusio.models.customer import CustomerDataSource
...
async def test_data_source_connection(
    ...
    if ds.source_type == DataSourceType.CSV:
        ...
        try:
            from uusio.ingestion.snowflake_ingestor import SnowflakeIngestor
